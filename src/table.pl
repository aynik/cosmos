...
table_env(X) :- new(X0),set(X0,"toListValues",table_toListValues,X1),set(X1,"toListKeys",table_toListKeys,X2),set(X2,"set",table_set,X3),set(X3,"get",table_get,X4),set(X4,"Cons",table_Cons,X5),set(X5,"Some",table_Some,X6),set(X6,"None",table_None,X7),set(X7,"Left",table_Left,X8),set(X8,"Right",table_Right,X9),X=X9.