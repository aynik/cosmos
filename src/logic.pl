%toString Relation Any String;instantied Relation Any;type Relation Any Any;iterate Relation Relation Integer Any Any;between Relation Any Any Any;listOf Relation Any Relation Any Functor;applyCatch Relation Relation Functor Relation;applyOnce Relation Relation Functor;apply Relation Relation Functor;exit Relation;throw Relation Any
...
logic_env(X) :- new(X0),set(X0,"toString",logic_toString,X1),set(X1,"instantied",logic_instantied,X2),set(X2,"type",logic_type,X3),set(X3,"iterate",logic_iterate,X4),set(X4,"between",logic_between,X5),set(X5,"listOf",logic_listOf,X6),set(X6,"applyCatch",logic_applyCatch,X7),set(X7,"applyOnce",logic_applyOnce,X8),set(X8,"apply",logic_apply,X9),set(X9,"exit",logic_exit,X10),set(X10,"throw",logic_throw,X11),math_env(Y11),set(X11,"math",Y11,X12),string_env(Y12),set(X12,"string",Y12,X13),list_env(Y13),set(X13,"list",Y13,X14),set(X14,"Cons",logic_Cons,X15),set(X15,"Some",logic_Some,X16),set(X16,"None",logic_None,X17),set(X17,"Left",logic_Left,X18),set(X18,"Right",logic_Right,X19),X=X19.